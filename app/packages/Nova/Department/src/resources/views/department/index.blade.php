            ...
            <div class="dept-stat-card">
                <div class="dept-stat-top">
                    <div>
                        ...
                        <div class="dept-stat-sub">6 tháng gần nhất</div>
                    </div>
            ...
            <div class="dept-stat-card">
                <div class="dept-stat-top">
                    <div>
                        ...
                        <div class="dept-stat-sub">Lũy kế 6 tháng</div>
                    </div>
                    <svg class="dept-sparkline" viewBox="0 0 80 32" preserveAspectRatio="none">
                        <defs>
            ...
            <div class="dept-stat-card">
                <div class="dept-stat-top">
                    <div>
                        ...
                        <div class="dept-stat-label">Chưa có trưởng phòng</div>
                        <div class="dept-stat-value">
                            {{ $departments->getCollection()->whereNull('manager_id')->count() }}
                        </div>
                        <div class="dept-stat-sub">Cần assign</div>
                    </div>
                    <svg class="dept-sparkline" viewBox="0 0 80 32" preserveAspectRatio="none">
                        <defs>
