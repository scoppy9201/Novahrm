...
@section('title', 'Sơ đồ tổ chức — NovaHRM')
...
@section('content')
    ...
    <header class="orgchart-topbar">
        <div class="orgchart-topbar-row1">
            <div>
                ...
                <div class="orgchart-page-title">Sơ đồ tổ chức</div>
            </div>
            <div class="orgchart-actions">
                <button class="btn-orgchart-icon" id="btn-export-png" title="Xuất PNG">
                    <svg viewBox="0 0 24 24"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                </button>
                <button class="btn-orgchart-icon" id="btn-fullscreen" title="Toàn màn hình">
        ...
        <div class="orgchart-topbar-tabs">
            <div class="orgchart-tab active" data-tab="so-do">Sơ đồ</div>
            <div class="orgchart-tab" data-tab="danh-sach">Danh sách</div>
        </div>
    </header>
    ...
    <div class="orgchart-toolbar" id="orgchart-toolbar">
        <div class="orgchart-search">
            ...
            <input type="text" id="orgchart-search-input" placeholder="Tìm nhân viên hoặc phòng ban..." autocomplete="off"/>
        </div>
        ...
        <div class="orgchart-toolbar-right">
            <div class="orgchart-view-toggle">
                <button class="orgchart-view-btn active" data-view="vertical" title="Dọc">
                    <svg viewBox="0 0 24 24"><line x1="12" y1="2" x2="12" y2="22"/><path d="M17 7l-5-5-5 5"/><path d="M17 17l-5 5-5-5"/></svg>
                </button>
                <button class="orgchart-view-btn" data-view="horizontal" title="Ngang">
                    <svg viewBox="0 0 24 24"><line x1="2" y1="12" x2="22" y2="12"/><path d="M7 7l-5 5 5 5"/><path d="M17 7l5 5-5 5"/></svg>
                </button>
                <button class="orgchart-view-btn" data-view="compact" title="Thu gọn">
                    <svg viewBox="0 0 24 24"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/></svg>
                </button>
            </div>
            <button class="btn-orgchart-icon" id="btn-fit-screen" title="Vừa màn hình">
                <svg viewBox="0 0 24 24"><path d="M15 3h6v6"/><path d="M9 21H3v-6"/><path d="M21 3l-7 7"/><path d="M3 21l7-7"/></svg>
            </button>
            <button class="btn-orgchart-icon" id="btn-collapse-all" title="Thu gọn tất cả">
    ...
    <div class="orgchart-toolbar" id="list-toolbar" style="display:none;">
        <div class="orgchart-search">
            <svg viewBox="0 0 24 24"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
            <input type="text" id="list-search-input" placeholder="Tìm phòng ban..." autocomplete="off"/>
        </div>
    ...
    <div id="section-so-do" style="flex:1; overflow:hidden; display:flex; flex-direction:column;">
        <div class="orgchart-body" id="orgchart-body">
            <div class="orgchart-loading" id="orgchart-loading">
                ...
                <div class="orgchart-loading-text">Đang tải sơ đồ...</div>
            </div>
            <div class="orgchart-canvas" id="orgchart-canvas"></div>
            <div class="orgchart-zoom-controls">
                <button class="orgchart-zoom-btn" id="btn-zoom-in" title="Phóng to">+</button>
                <div class="orgchart-zoom-label" id="zoom-label">100%</div>
                <button class="orgchart-zoom-btn" id="btn-zoom-out" title="Thu nhỏ">−</button>
            </div>
        </div>
    </div>
    ...
    <div id="section-danh-sach" style="display:none; flex:1; overflow:auto; width:100%;">
        <div class="orgchart-list-wrap">
            ...
            <div class="orgchart-list-empty" id="list-empty" style="display:none;">
                ...
                <div class="orgchart-empty-text">Không tìm thấy phòng ban</div>
                <div class="orgchart-empty-sub">Thử thay đổi bộ lọc hoặc từ khóa tìm kiếm</div>
            </div>
        </div>
    </div>
    ...
    <div class="orgchart-drawer" id="orgchart-drawer">
        <div class="orgchart-drawer-header">
            <div class="orgchart-drawer-title" id="drawer-title">Chi tiết</div>
