...
<div class="doc-modal-overlay" id="modal-delete">
    <div class="doc-modal doc-modal-sm">
        <div class="doc-modal-head">
            <div class="doc-modal-title">Xoá tài liệu</div>
        ...
        <div class="doc-modal-body">
            <div class="doc-alert doc-alert-error">
                ...
                <div>
                    Bạn chắc chắn muốn xoá <strong>{{ $document->file_name }}</strong>?
        ...
        <div class="doc-modal-foot">
            <button type="button" class="doc-btn doc-btn-secondary" onclick="closeModal('modal-delete')">Huỷ</button>
