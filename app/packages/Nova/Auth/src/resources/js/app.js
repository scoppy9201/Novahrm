import '../css/app.css'
import './nova-id'   // Nova ID module (Magic Link + OTP)
...
// Toast đăng nhập / đăng xuất 
if (window.__loginSuccess)  novaToast('Đăng nhập thành công! Chào mừng trở lại.', 'success');
if (window.__logoutSuccess) novaToast('Đăng xuất thành công. Hẹn gặp lại!', 'success');
