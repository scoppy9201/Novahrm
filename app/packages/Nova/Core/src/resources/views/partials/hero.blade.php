...
<section class="hero">
    ...
    <div class="hero-content">
        ...
        <h1 class="hero-title">
            <span class="line-blue">Tự động hoá </span><span class="line-white" style="display:inline">tuyển dụng</span>
            <span class="line-white">Vận hành công ca <span class="line-blue">linh hoạt</span></span>
            <span class="line-white">Giữ chân <span class="line-blue">nhân tài</span></span>
        </h1>
        <p class="hero-desc">
    ...
    <div class="hero-preview">
        <div class="hbm-stage">
            ...
            <div class="hbm-panel hbm-panel-left">
                <div class="hbm-mobile">
                    ...
                    <div class="hbm-mob-emp">
                        ...
                        <div>
                            <div style="font-size:9px;font-weight:800;color:#fff;line-height:1.2">Bùi Mạnh Hưng</div>
                            <div style="font-size:7.5px;color:#60A5FA">Trưởng phòng Kinh doanh</div>
                        </div>
                        <div class="hbm-mob-live">● Live</div>
                    </div>
    
                    <!-- todo label -->
                    <div class="hbm-mob-section-label">Lịch sử làm việc</div>
                    ...
                    <div class="hbm-mob-timeline">
                        <div class="hbm-tl-item">
                            ...
                            <div class="hbm-tl-content">
                                <div class="hbm-tl-title">Thứ 5, 30/03/2025</div>
                                <div class="hbm-tl-sub">8 giờ làm việc</div>
                            </div>
                        ...
                        <div class="hbm-tl-item hbm-tl-warn">
                            ...
                            <div class="hbm-tl-content">
                                <div class="hbm-tl-title" style="color:#f87171">11 ngày tới hết phép</div>
                                <div class="hbm-tl-sub">Phép năm còn lại</div>
                            </div>
                    ...
                    <!-- quick menu 2x2 -->
                    <div class="hbm-mob-section-label" style="margin-top:6px">Thao tác nhanh</div>
                    ...
                    <!-- bảng lương mini -->
                    <div class="hbm-mob-section-label" style="margin-top:8px">Bảng lương của bạn</div>
                    <div class="hbm-mob-payroll">
                        <div class="hbm-payroll-tag">Payroll 02/2025</div>
                        <div class="hbm-payroll-val">11,440,000đ</div>
            ...
            <!-- ── PANEL GIỮA: Desktop App (to nhất, trung tâm) ── -->
                ...
                <div class="hbm-desktop">
                    ...
                    <div class="hbm-desk-topbar">
                        ...
                        <div style="display:flex;align-items:center;gap:5px">
                            ...
                            <div style="font-size:9px;color:var(--text-dim)">Danh sách nhân sự</div>
                        </div>
                        <div style="display:flex;align-items:center;gap:8px;margin-left:auto">
                            <div style="width:6px;height:6px;border-radius:50%;background:#22c55e;box-shadow:0 0 6px #22c55e"></div>
                            <span style="font-size:9px;color:#22c55e;font-weight:700">Trực tuyến</span>
                        </div>
                    </div>
                    ...
                    <div class="hbm-desk-body">
                        ...
                        <div class="hbm-desk-sidebar">
                            ...
                            <div class="hbm-ds-item">
                                ...
                                <span>Đánh giá & phân hối</span>
                            </div>
                        </div>
    
                        <!-- Main Content -->
                        <div class="hbm-desk-main">
                            <div class="hbm-desk-page-title">Các thông tin về công việc &amp; sự nghiệp</div>
                            ...
                            <div class="hbm-emp-headerrow" style="gap:5px">
                                ...
                                <div> 
                                    <div style="font-size:13px;font-weight:800;color:#fff">Bùi Mạnh Hưng</div>
                                    <div style="font-size:9px;color:#60A5FA;margin-top:1px">Trưởng phòng kinh doanh</div>
                                    <div style="font-size:8px;color:var(--text-dim);margin-top:2px">● 1 năm 2 tháng 22 ngày làm việc</div>
                                </div>
                                <div style="display:flex;gap:5px;align-items:center;margin-left:auto">
                                    <div class="hbm-action-btn">Sửa thông tin công việc</div>
                                    <div class="hbm-action-btn hbm-action-primary">Sửa thông tin lương ▾</div>
                                </div>
                            </div>
    
                            <!-- Section: THÔNG TIN CÔNG VIỆC -->
                            <div class="hbm-section-label">THÔNG TIN CÔNG VIỆC</div>
                            <div class="hbm-info-grid6">
                                <div class="hbm-ig-item"><div class="hbm-ig-label">Vị trí công việc</div><div class="hbm-ig-val">Trưởng phòng kinh doanh</div></div>
                                <div class="hbm-ig-item"><div class="hbm-ig-label">Văn phòng</div><div class="hbm-ig-val">🌐 Tổng công ty</div></div>
                                <div class="hbm-ig-item"><div class="hbm-ig-label">Phân loại nhân sự</div><div class="hbm-ig-val">Toàn thời gian</div></div>
                                <div class="hbm-ig-item"><div class="hbm-ig-label">Khu vực / Chuyển nơi</div><div class="hbm-ig-val">📦 Logistic</div></div>
                                <div class="hbm-ig-item"><div class="hbm-ig-label">Chính sách lương</div><div class="hbm-ig-val">🏠 BL Tây Bắc</div></div>
                                <div class="hbm-ig-item"><div class="hbm-ig-label">Ngày bắt đầu</div><div class="hbm-ig-val">12/04/2024</div></div>
                                <div class="hbm-ig-item"><div class="hbm-ig-label">Ngày chính thức</div><div class="hbm-ig-val">01/07/2020</div></div>
                                <div class="hbm-ig-item"><div class="hbm-ig-label">Mẫu lịch Văn phòng</div><div class="hbm-ig-val">📅 Mẫu lịch VP</div></div>
                                <div class="hbm-ig-item"><div class="hbm-ig-label">Lương</div><div class="hbm-ig-val">35,000,000</div></div>
                                <div class="hbm-ig-item"><div class="hbm-ig-label">Lương cơ bản</div><div class="hbm-ig-val" style="color:#22c55e;font-weight:700">20,000,000</div></div>
                            </div>
    
                            <!-- Section: THÀNH TỰU -->
                            <div class="hbm-section-label" style="margin-top:10px">THÀNH TỰU, CÔNG HIẾN</div>
                            <div class="hbm-achievements">
                                <div class="hbm-ach-item">
                                    <div class="hbm-ach-icon">🏆</div>
                                    <div class="hbm-ach-label">Nhân viên xuất sắc của năm</div>
                                </div>
                                <div class="hbm-ach-item">
                                    <div class="hbm-ach-icon">🥇</div>
                                    <div class="hbm-ach-label">1,000,000,000đ doanh thu</div>
                                </div>
                                <div class="hbm-ach-item">
                                    <div class="hbm-ach-icon">🔥</div>
                                    <div class="hbm-ach-label">Sự cạnh tranh</div>
                                </div>
                                <div class="hbm-ach-item">
                                    <div class="hbm-ach-icon">💙</div>
                                    <div class="hbm-ach-label">Người đồng đội tuyệt vời</div>
                                </div>
                                <div class="hbm-ach-item">
                                    <div class="hbm-ach-icon">🎯</div>
                                    <div class="hbm-ach-label">100 khách hàng</div>
                                </div>
                                <div class="hbm-ach-item">
                                    <div class="hbm-ach-icon">⭐</div>
                                    <div class="hbm-ach-label">Nghị lực hành trình mới</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!-- ── PANEL PHẢI: Salary Card (nổi cao hơn) ── -->
                ...
                <div class="hbm-salary-card">
                    ...
                    <div class="hbm-sal-header">
                        <div style="display:flex;align-items:center;gap:6px">
                            ...
                            <span style="font-size:11px;font-weight:700;color:#e0eeff">Bảng lương</span>
                        </div>
                    ...
                    <div class="hbm-sal-tabs">
                        <div class="hbm-sal-tab active">Tổng quan</div>
                        <div class="hbm-sal-tab">Phụ lương</div>
                        <div class="hbm-sal-tab">Phúc lợi</div>
                    </div>
    
                    <!-- big number -->
                    <div class="hbm-sal-label">Thực nhận gần đây</div>
                    <div class="hbm-sal-big">23,648,547<span class="hbm-sal-unit">.73 đ</span></div>
                    ...
                    <div class="hbm-sal-chart-wrap">
                        <svg class="hbm-line-chart" viewBox="0 0 200 70" preserveAspectRatio="none">
                            ...
                            <!-- area fill -->
                            <path d="M0,55 C20,50 40,45 60,40 C80,35 100,38 120,30 C140,22 160,28 200,10 L200,70 L0,70 Z"
                                fill="url(#salGrad)"/>
                            <!-- line -->
                            <path d="M0,55 C20,50 40,45 60,40 C80,35 100,38 120,30 C140,22 160,28 200,10"
                        ...
                        <div class="hbm-chart-axis">
                            <span>T9</span><span>T10</span><span>T11</span><span>T12</span><span>T1</span><span>T2</span>
                        </div>
                    </div>
                    ...
                    <div class="hbm-sal-rows">
                        <div class="hbm-sal-row">
                            ...
                            <span style="color:#e0eeff">20,000,000đ</span>
                        </div>
                        <div class="hbm-sal-row">
                            <div style="display:flex;align-items:center;gap:5px">
                            ...
                            <span style="color:#22c55e">+4,848,547đ</span>
                        </div>
                        <div class="hbm-sal-row">
                            <div style="display:flex;align-items:center;gap:5px">
                            ...
                            <span style="color:#f87171">-1,200,000đ</span>
                        </div>
                    </div>
    
                    <!-- mini progress bars -->
                    <div class="hbm-sal-progress">
                        <div style="font-size:8px;color:var(--text-dim);margin-bottom:5px;font-weight:700;letter-spacing:0.5px">PHÂN BỔ LƯƠNG</div>
                        ...
                        <div style="display:flex;justify-content:space-between;margin-top:4px">
                            <span style="font-size:7.5px;color:#60A5FA">Thực nhận 83%</span>
                            <span style="font-size:7.5px;color:var(--text-dim)">Khấu trừ 17%</span>
                        </div>
                    </div>
                </div>
            </div>
